...
test_ocaml() {
     cat test_repl.ml | ocaml | grep 1dfde4ba-3fd3-417b-b8c2-002092f1e42e >/dev/null
}
...
if ocamlc graphics.cma test_compile.ml; then
...
if ocamlopt graphics.cmxa test_compile.ml; then
